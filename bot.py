...
dp.message.register(
    ...
    F.from_user.id == ADMIN_ID,
    lambda m: clean_button_text(m.text) in {"ডাটাবেজ", "ডাউনলোড ডাটাবেজ", "আপলোড ডাটাবেজ", "ডিলিট অল ডাটা", "YES", "CANCEL"} or state.get(ADMIN_ID, {}).get("action") in {"database_upload", "database_delete_confirm"}
)
dp.message.register(
