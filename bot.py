...
def _button_meta(text):
    ...
    rules = [
        ...
        (("work management",), "admin_work_management", "primary"),
        (("force join",), "admin_force_join", "primary"),
        (("pending files", "pending file"), "admin_pending_file", "primary"),
        (("generate main excel",), "admin_generate_excel", "primary"),
        ...
        (("new button",), "admin_new_button", "primary"),
        (("database",), "admin_database", "primary"),
        (("maintenance",), "admin_maintenance", "primary"),
        (("support",), "admin_support", "primary"),
        ...
        (("add work",), "admin_add_work", "primary"),
        (("disable notice",), "admin_disable_notice", "danger"),
        (("work list",), "admin_work_list", "primary"),
        (("add withdrawal category",), "admin_add_withdrawal_category", "primary"),
        (("pending withdrawal requests",), "admin_pending_withdrawal", "primary"),
        (("add force join channel",), "admin_add_force_join_channel", "primary"),
        (("force join channel list",), "admin_force_join_list", "primary"),
        (("remove force join channel",), "admin_remove_force_join", "danger"),
        (("add new button",), "admin_add_new_button", "primary"),
        (("view added button",), "admin_view_added_button", "primary"),
        (("edit added button",), "admin_edit_added_button", "primary"),
        (("download database",), "admin_download_database", "primary"),
        (("upload database",), "admin_upload_database", "primary"),
        (("ডিলিট অল ডাটা", "delete all data"), "admin_delete_all_data", "danger"),
        (("maintenance on",), "admin_maintenance_on", "success"),
        (("maintenance off", "maintains off"), "admin_maintenance_off", "danger"),
        (("support management",), "admin_support", "primary"),
        (("withdrawal management",), "admin_withdrawal_management", "primary"),
        ...
        (("add support button",), "admin_add_support", "primary"),
        ...
        (("view added button",), "admin_view_added_button", "primary"),
        (("edit added button",), "admin_edit_added_button", "primary"),
        (("upload report file",), "admin_upload_report", "primary"),
        (("add withdrawal category",), "admin_add_withdrawal_category", "primary"),
        (("add force join channel",), "admin_add_force_join_channel", "primary"),
        (("remove force join channel",), "admin_remove_force_join", "danger"),
        (("add new button",), "admin_add_new_button", "primary"),
