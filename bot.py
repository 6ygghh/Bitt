...
async def send_payment_approval_report(bot, w):
    ...
    try:
        ...
        # Build the channel report directly. Each Premium Emoji ID is
        # attached to its own visible fallback emoji as a Telegram entity.
        parts = [
            ("━━━━━━━━━━━━━━━━━━\\n", None),
            ("⭐", "5420592870396557986"),
            (" NEW PAYMENT APPROVED\\n━━━━━━━━━━━━━━━━━━\\n\\n", None),
            ("⭐", "5325971446625758812"),
            (f" Name : {w['full_name'] or 'N/A'}\\n", None),
            ("⭐", "5291913773307667021"),
            ...
            ("━━━━━━━━━━━━━━━━━━\\n", None),
            ("⭐", "5391218287684116768"),
            (f" Total Withdrawal : {float(total):.2f} টাকা\\n━━━━━━━━━━━━━━━━━━\\n\\n", None),
            ("⭐", "6066904368051916008"),
            (" Payment has been approved successfully.", None),
        ]
        ...
        offset = 0
        for value, emoji_id in parts:
            if emoji_id:
                message += value
                length = u16_len(value)
                entities.append(
                    MessageEntity(
                        type="custom_emoji",
                        offset=offset,
