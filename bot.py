...
async def review_confirm_callback(q):
    ...
    try:
        await q.message.bot.send_message(s["user_id"],
            f"<tg-emoji emoji-id="5203993413346680064"></tg-emoji> Report Review Complete

━━━━━━━━━━━━━━━━━━
<tg-emoji emoji-id="5431420628978641216"></tg-emoji> Review Summary

<tg-emoji emoji-id="5438605546624132206"></tg-emoji> Submitted        : {s['rows_count']}
<tg-emoji emoji-id="5951982867255924070"></tg-emoji> Accepted         : {r['accepted_count']}
<tg-emoji emoji-id="5208928614237623166"></tg-emoji> Rejected         : {r['accepted_count'] if False else r['rejected_count']}
━━━━━━━━━━━━━━━━━━
<tg-emoji emoji-id="5224257782013769471"></tg-emoji> Added to Balance : {r['final_amount']:.2f}
━━━━━━━━━━━━━━━━━━

<tg-emoji emoji-id="6235311100879968812"></tg-emoji> Your File Has been Reviewed Successfully.",
