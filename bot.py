...
async def sell(m):
    ...
    if not r:
        return await ans(
            ...
            "╭━━━〔 ⏰ SUBMISSION STATUS 〕━━━╮\n"
            "│\n"
            "│ 🛑 <b>এই মুহূর্তে ফাইল জমা নেওয়া হচ্ছে না।</b>\n"
            "│\n"
            "│ 👨‍💼 এডমিন বর্তমানে ফাইল জমা নেওয়া\n"
            "│    বা কাজ সাময়িকভাবে বন্ধ রেখেছেন।\n"
            "│\n"
            "│ 📅 <b>ফাইল সাবমিট করার সময়সূচী</b>\n"
            "│ 🇧🇩 বাংলাদেশ সময়: <b>সন্ধ্যা 07:00 — রাত 09:30</b>\n"
            "│\n"
...
async def admin(m):
    ...
    try:
        ...
        if a=="work_toggle_id":
            ...
            if not row:
                return await ans(m, "❌ Work ID পাওয়া যায়নি। আবার সঠিক ID দিন।")
            ...
            if toggle == 0:
                ...
                notify_text = (
                    ...
                    f"│ 📂 <b>{row['name']}</b>\n"
                    "│\n"
                    "│ এই ক্যাটাগরির কাজ বর্তমানে\n"
                    "│ <b>এডমিন বন্ধ করে দিয়েছেন।</b>\n"
                    "│\n"
                    "│ 🕰️ নতুন ফাইল সাবমিট করার সময়\n"
                    "│ 🇧🇩 <b>সন্ধ্যা 07:00 — রাত 09:30</b>\n"
                    "│\n"
                    "│ ✨ কাজটি আবার চালু হলে আপনি\n"
                    "│    পুনরায় ফাইল সাবমিট করতে পারবেন।\n"
                    "╰━━━━━━━━━━━━━━━━━━━━━━╯"
                )
                ...
                return await ans(
                    m,
                    f"🔴 <b>{row['name']}</b> disable করা হয়েছে।\n\n"
                    f"📨 Notification sent: <b>{sent}</b>\n"
                    f"⚠️ Failed/blocked: <b>{failed}</b>",
                    reply_markup=am()
                )
            return await ans(m, f"🟢 <b>{row['name']}</b> enable করা হয়েছে।", reply_markup=am())
