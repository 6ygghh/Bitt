...
async def doc(m):
    ...
    caption=f"""✦ 𝐍𝐄𝐖 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐅𝐈𝐋𝐄 ✦
━━━━━━━━━━━━━━━━━━━━

⌁ 𝐒𝐮𝐛𝐦𝐢𝐬𝐬𝐢𝐨𝐧 𝐈𝐃   : `{sid}`
⌁ 𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞          : @{m.from_user.username or 'N/A'}
⌁ 𝐔𝐬𝐞𝐫 𝐈𝐃              : `{m.from_user.id}`

◈ 𝐖𝐨𝐫𝐤                  : {cat['name']}
◈ 𝐀𝐜𝐜𝐨𝐮𝐧𝐭𝐬            : `{n}`

◆ 𝐏𝐫𝐢𝐜𝐞                   : `{cat['price']:.2f}`
◆ 𝐄𝐬𝐭𝐢𝐦𝐚𝐭𝐞𝐝 𝐏𝐫𝐨𝐟𝐢𝐭 : `{profit:.2f}`

▸ 𝐅𝐢𝐥𝐞                    : `{fn}`
◷ 𝐓𝐢𝐦𝐞                  : `{now()}`

━━━━━━━━━━━━━━━━━━━━
⟡ 𝐏𝐋𝐄𝐀𝐒𝐄 𝐑𝐄𝐕𝐈𝐄𝐖 𝐓𝐇𝐈𝐒 𝐒𝐔𝐁𝐌𝐈𝐒𝐒𝐈𝐎𝐍 ✦"""
...
async def review_confirm_callback(q):
    ...
    try:
        await q.message.bot.send_message(s["user_id"],
            f"✨ <b>File Review Complete</b> ✨\n\n"
            f"━━━━━━━━━━━━━━━━━━\n"
            f"📄 <b>Review Summary</b>\n\n"
            f"📦 Submitted      : <b>{s['rows_count']}</b>\n"
            f"✅ Accepted        : <b>{r['accepted_count']}</b>\n"
            f"❌ Rejected        : <b>{r['rejected_count']}</b>\n"
            f"━━━━━━━━━━━━━━━━━━\n"
            f"💰 Added to Balance: <b>{r['final_amount']:.2f}</b>\n"
            f"━━━━━━━━━━━━━━━━━━\n\n"
            f"🎉 Your file has been reviewed successfully.",
            parse_mode="HTML", reply_markup=um(s["user_id"]))
    except: pass
...
dp.message.register(
    pending_withdrawals_requests_direct,
    F.from_user.id == ADMIN_ID,
