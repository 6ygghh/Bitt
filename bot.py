...
async def work_menu_action(m):
    ...
    if t=="Disable Notice":
        ...
        current=setting("disable_notice_text", "")
        return await ans(m,
            "🔕 Disable Notice\n\n"
            "User-এর কোনো Active Work না থাকলে যে notice দেখাবে সেটি এখন একটি message হিসেবে পাঠান।\n"
            "Premium/Custom Emoji, bold, line break এবং formatting সহ পাঠালে সেগুলো সংরক্ষণ করা হবে।\n\n"
            + ("বর্তমান notice সেট আছে। নতুন message পাঠালে সেটি replace হবে।" if current else "এখনো কোনো custom notice সেট করা হয়নি।"),
