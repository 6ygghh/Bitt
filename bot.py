...
def _button_meta(text):
    ...
    rules = [
        ...
        (("Delete All Data", "delete all data"), "admin_delete_all_data", "danger"),
...
dp.message.register(
    ...
    F.from_user.id == ADMIN_ID,
    lambda m: clean_button_text(m.text) in {"Database", "Download Database", "Upload Database", "Delete All Data", "YES", "CANCEL"} or state.get(ADMIN_ID, {}).get("action") in {"database_upload", "database_delete_confirm"}
)
dp.message.register(
