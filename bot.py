...
async def review_confirm_callback(q):
    ...
    try:
        await q.message.bot.send_message(s["user_id"],
            f"✦ 𝐅𝐈𝐋𝐄 𝐑𝐄𝐕𝐈𝐄𝐖 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝐄 ✦\n\n"
            f"━━━━━━━━━━━━━━━━━━\n"
            f"⌁ 𝐑𝐄𝐕𝐈𝐄𝐖 𝐒𝐔𝐌𝐌𝐀𝐑𝐘\n\n"
            f"◈ 𝐒𝐮𝐛𝐦𝐢𝐭𝐭𝐞𝐝       : {s['rows_count']}\n"
            f"✦ 𝐀𝐜𝐜𝐞𝐩𝐭𝐞𝐝        : {r['accepted_count']}\n"
            f"✧ 𝐑𝐞𝐣𝐞𝐜𝐭𝐞𝐝        : {r['rejected_count']}\n"
            f"━━━━━━━━━━━━━━━━━━\n"
            f"◆ 𝐀𝐝𝐝𝐞𝐝 𝐭𝐨 𝐁𝐚𝐥𝐚𝐧𝐜𝐞 : {r['final_amount']:.2f}\n"
            f"━━━━━━━━━━━━━━━━━━\n\n"
            f"✦ 𝐘𝐨𝐮𝐫 𝐟𝐢𝐥𝐞 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐫𝐞𝐯𝐢𝐞𝐰𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲.",
