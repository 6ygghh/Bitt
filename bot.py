...
async def review_confirm_callback(q):
    ...
    try:
        await q.message.bot.send_message(s["user_id"],
            f"{{PE:5203993413346680064}} File Review Complete\n\n━━━━━━━━━━━━━━━━━━\n{{PE:5431420628978641216}} Review Summary\n\n{{PE:5438605546624132206}} Submitted      : {s['rows_count']}\n{{PE:5951982867255924070}} Accepted       : {r['accepted_count']}\n{{PE:5208928614237623166}} Rejected       : {r['rejected_count']}\n━━━━━━━━━━━━━━━━━━\n{{PE:5224257782013769471}} Added to Balance : {r['final_amount']:.2f}\n━━━━━━━━━━━━━━━━━━\n\n{{PE:6235311100879968812}} Your File Has Been Reviewed Successfully.",
